...
describe('Tests for entities', function () {
    ...
    it('tests the spliceOne method', function () {
        var arr = [1, 2, 3];
    ...
    it('Tests that internal groups are created correctly', function () {
        var e = new Entity(null);
        var comp = { name: 'test', foo: 'bar' };
        var e2 = new Entity(null);
        var comp2 = { name: 'foo', foo: 'test' };
        e.addComponent(comp);
    ...
    it('Tests the hasComponent method', function () {
        var e = new Entity(null);
        var comp1 = { name: 'test1', foo: 'bar' };
        e.addComponent(comp1);
        var comp2 = { name: 'test2', foo: 'bar' };
    ...
    it('Test the getByComp static method', function () {
        var e = new Entity(null);
        var comp1 = { name: 'test1', foo: 'bar' };
        e.addComponent(comp1);
        var comp2 = { name: 'test2', foo: 'bar' };
    ...
    it('Entity can destroy itself', function () {
        var e = new Entity(null);
        var comp1 = { name: 'test1', foo: 'bar' };
        e.addComponent(comp1);
        ...
        var resp = Entity.getByComps(['test1'], 'array');
